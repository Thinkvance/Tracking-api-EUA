...
async function getVendorTrackingDetails_ICLSelf(requestBody) {
  try {
    const response = await axios.post(
      "http://nextcloud.iclinternational.in/api/v1/Tracking/Tracking",
      requestBody
    );
...
export default getVendorTrackingDetails_ICLSelf;
